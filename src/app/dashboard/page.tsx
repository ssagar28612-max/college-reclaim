...
import { Package, Heart, Calendar, User } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Items you've reported lost</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">0</div>
              <p className="text-xs text-muted-foreground">Items you've reported found</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-600 dark:text-gray-400">
                Your dashboard is ready. Start reporting lost or found items to see your activity here.
              </p>
            </CardContent>
          </Card>
        </div>
